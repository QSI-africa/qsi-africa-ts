...
import { 
  Lock, ArrowRight, Compass, FlaskConical, Users, Globe 
} from 'lucide-react';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          This section is reserved for registered QSI members. Create a free account or log in to manage your profile, view requests, and access billing services.
        </p>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '11px', textTransform: 'uppercase', fontWeight: 800, letterSpacing: '0.1em', color: 'rgba(255,255,255,0.25)' }}>
          ...
          {publicRoutesList.map((item, idx) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                {item.icon}
                <span style={{ fontWeight: 800, fontSize: '13px', color: 'white' }}>{item.title}</span>
              </div>
