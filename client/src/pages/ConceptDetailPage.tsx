  ...
  return (
    <>
      ...
      <div style={{
        ...
        <button onClick={() => navigate('/concepts')} className="qsi-btn qsi-btn-secondary" style={{ padding: '8px 16px', borderRadius: '10px' }}>
