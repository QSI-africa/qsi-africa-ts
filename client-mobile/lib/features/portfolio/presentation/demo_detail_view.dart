...
class DemoDetailView extends StatefulWidget {
  final String id;
  const DemoDetailView({super.key, required this.id});

  @override
  State<DemoDetailView> createState() => _DemoDetailViewState();
}

class _DemoDetailViewState extends State<DemoDetailView> {
  @override
  void initState() {
    super.initState();
    context.read<PortfolioBloc>().add(FetchItemDetail(widget.id, PortfolioType.demo));
  }
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    ...
                    Row(
                      ...
                      children: [
                        _buildMetaItem(LucideIcons.mapPin, 'LOCATION', 'Lagos Sector'),
                        _buildMetaItem(LucideIcons.activity, 'STATUS', 'Operational'),
                        _buildMetaItem(LucideIcons.layers, 'NODE', item.category),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Establish technical coherence within this physical node ecosystem.',
